...
## ⚠️ Рассинхрон документации

Корневой `CLAUDE.md` описывает **другой** проект (AFM — fraud/social-media платформа)
и не соответствует коду `medserviceprice/`. Источник истины — код и этот файл.
